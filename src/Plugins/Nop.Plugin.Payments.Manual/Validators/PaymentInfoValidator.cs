...
namespace Nop.Plugin.Payments.Manual.Validators
{
    public class PaymentInfoValidator : BaseNopValidator<PaymentInfoModel>
    {
        public PaymentInfoValidator(ILocalizationService localizationService)
        {
            ...
            //RuleFor(x => x.CardNumber).NotEmpty().WithMessage(localizationService.GetResourceAsync("Payment.CardNumber.Required"));
            //RuleFor(x => x.CardCode).NotEmpty().WithMessage(localizationService.GetResourceAsync("Payment.CardCode.Required"));
