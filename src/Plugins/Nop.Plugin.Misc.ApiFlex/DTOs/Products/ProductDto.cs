...
namespace Nop.Plugin.Misc.ApiFlex.DTO.Products
{
    ...
    public class ProductDto : BaseDto
    {
        ...
        public void Merge(ref Product product)
        {
            product.Name = this.Name;
            product.Sku = this.Sku;
            product.Price = (decimal)this.Price;
            product.ShortDescription = this.ShortDescription;
            product.Published = (bool)this.Published;
            
            product.StockQuantity = (int)this.StockQuantity;
            
            product.Gtin = this.Gtin;
            product.IsTaxExempt = (bool)this.IsTaxExempt;

            product.ManageInventoryMethod = (ManageInventoryMethod)this.ManageInventoryMethodId;
        }
    }
}