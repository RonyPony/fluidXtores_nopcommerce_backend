...
namespace Nop.Plugin.Misc.ApiFlex.DTO.Orders
{
    ...
    public class OrderDto : BaseDto
    {
        ...
        /// <summary>
        /// Get or sets the order discount coupon code
        /// </summary>
        [JsonProperty("order_discount_coupon_code")]
        public string OrderDiscountCouponCode { get; set; }
        ...
        [JsonProperty("shipping_address_coordinates")]
        public AddressWithCoordinatesDto BillingAddressWithCoordinates { get; set; }

        [JsonProperty("payment_method_checkout_attribute")]
        public string PaymentMethodCheckoutAttribute { get; set; }

        [JsonProperty("order_delivery_indications_checkout_attribute")]
        public string OrderDeliveryIndicationsCheckoutAttribute { get; set; }
