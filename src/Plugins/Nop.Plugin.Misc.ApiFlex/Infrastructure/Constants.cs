...
namespace Nop.Plugin.Misc.ApiFlex.Infrastructure
{
    public static class Constants
    {
        ...
        public static class ViewNames
        {
            ...
            public const string AdminApiSettings = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Settings.cshtml";
            public const string AdminApiClientsCreateOrUpdate = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Clients/CreateOrUpdate.cshtml";
            public const string AdminApiClientsSettings = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Clients/ClientSettings.cshtml";
            public const string AdminApiClientsList = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Clients/List.cshtml";
            public const string AdminApiClientsCreate = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Clients/Create.cshtml";
            public const string AdminApiClientsEdit = "~/Plugins/Nop.Plugin.Misc.ApiFlex/Views/Clients/Edit.cshtml";
        }
