...
using Nop.Plugin.Misc.ApiFlex.Models.CustomersParameters;
using Nop.Plugin.Misc.ApiFlex.ModelBinders;
using Nop.Plugin.Misc.ApiFlex.Helpers;
using Nop.Plugin.Misc.ApiFlex.Delta;
...
namespace Nop.Plugin.Misc.ApiFlex.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="fields">Fields from the customers you want your json to contain</param>
        ...
        public async Task<IActionResult> CreateCustomerAsync([ModelBinder(typeof(JsonModelBinder<CustomerDto>))] Delta<CustomerDto> customerDelta)
        {
            ...
            var customer = new Customer();//CustomerService.GetCustomerByEmailAsync(customerDelta.Dto.Email);
            ...
            //var newCustomerDto = await IDTOHelper.PrepareCustomerDTOAsync(newCustomer);
        ...
        public async Task<IActionResult> UpdateCustomerAsync([ModelBinder(typeof(JsonModelBinder<CustomerDto>))] Delta<CustomerDto> customerDelta)
        {
            ...
            // Preparing the result dto of the new customer
            // We do not prepare the shopping cart items because we have a separate endpoint for them.
            var updatedCustomer = new CustomerDto();// await _dtoHelper.PrepareCustomerDTOAsync(currentCustomer);
